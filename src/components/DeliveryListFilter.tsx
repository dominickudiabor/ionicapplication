...
import './DeliveryListFilter.css'

import { connect } from '../data/connect';
import { updateFilteredTracks } from '../data/deliveries/deliveries.actions';
...
type DeliveryListFilterProps = OwnProps & StateProps & DispatchProps;

const DeliveryListFilter: React.FC<DeliveryListFilterProps> = ({ allTracks, filteredTracks, onDismissModal, updateFilteredTracks }) => {
